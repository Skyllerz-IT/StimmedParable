...
public class EnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            colorAdjustments.postExposure.value = Mathf.Lerp(0f, 3f, effectLerp);
            colorAdjustments.saturation.value = Mathf.Lerp(0f, -100f, effectLerp);
        }
